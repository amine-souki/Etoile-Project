...
// Updated football team data with more players and structure
...
// Mock data for other sports (simplified)
const otherSportData: { [key: string]: any } = {
  handball: {
    name: 'Handball',
    icon: Hand,
    team: [{ name: 'Player A', position: 'Pivot', imageUrl: 'https://picsum.photos/100/100?random=21' }, { name: 'Player B', position: 'Arrière', imageUrl: 'https://picsum.photos/100/100?random=22' }],
  ...
  basketball: {
    name: 'Basketball',
    icon: Dribbble,
    team: [{ name: 'Player X', position: 'Meneur', imageUrl: 'https://picsum.photos/100/100?random=31' }, { name: 'Player Y', position: 'Ailier', imageUrl: 'https://picsum.photos/100/100?random=32' }],
  ...
  volleyball: {
    name: 'Volleyball',
    icon: Volleyball,
    team: [{ name: 'Player P', position: 'Central', imageUrl: 'https://picsum.photos/100/100?random=41' }, { name: 'Player Q', position: 'Passeur', imageUrl: 'https://picsum.photos/100/100?random=42' }],
...
function getSportDetails(sport: string) {
    if (sport.toLowerCase() === 'football') {
      // Combine general info with detailed team data for football
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-3 border-b pb-4 mb-6">
        ...
        <h1 className="text-3xl font-bold">Équipe Première</h1> {/* Updated Title */}
      </div>
          ...
          <Tabs defaultValue="effectif" className="w-full">
              ...
              <TabsContent value="presentation">
                  ...
                  <Card>
                      ...
                      <CardContent>
                          <p>Présentation de la section football à venir...</p>
                          ...
                          {sportDetails.team.map((player: any) => (
                              <div key={player.name} className="text-center p-2 border rounded-lg hover:shadow-sm transition-shadow">
                                  <Image
                                      ...
                                      data-ai-hint="sports player action" // Generic hint
                                  />
